...
group_CSSE.head(10).plot.pie(y='Deaths', figsize=(12, 9),autopct='%1.1f%%')
...
#plot a pie chart regarding the top 5 deaths of countries
group_CSSE = group_CSSE.set_index('Country_Region')
group_CSSE.head(10).plot.pie(y='Confirmed', figsize=(10, 10),autopct='%1.1f%%')
...
#a bar plot to show the top 5 deaths of countries
sns.barplot(x='Country_Region', y='Confirmed', data = group_CSSE.head(5)).set_title('Regions with more deaths')
plt.show()
...
#bar plot regarding the top 5 total confirmed cases when it comes to province state
sns.barplot(x='Province_State', y='Deaths', data = group_CSSE.head(5)).set_title('US States with more deaths')
plt.show()
